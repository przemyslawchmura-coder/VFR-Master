...
const output = process.argv.includes("--field-gaps")
  ? require("../js/research/research-coverage-auditor.js").renderFieldGapReport(dataset, deepKeys)
  : process.argv.includes("--owner-manual-audit")
