(function attachTechnicalProfilePresentation(root, factory) {
  ...
  const CORE_FIELD_LABELS = Object.freeze({
    "engine.displacement": "Pojemność silnika", "engine.power": "Moc silnika", "mass.wet-kerb": "Masa gotowa do jazdy", "fuel-tank.capacity": "Pojemność zbiornika paliwa", "oil.specification": "Specyfikacja oleju", "oil.viscosity": "Lepkość oleju", "oil.quantity-drain": "Ilość oleju po zwykłym spuszczeniu", "oil.quantity-filter": "Ilość oleju z wymianą filtra", "oil-filter.reference": "Numer / typ filtra oleju", "oil.drain-plug-torque": "Moment dokręcania korka spustowego oleju", "oil.filter-torque": "Moment dokręcania filtra oleju", "oil.replacement-interval": "Interwał wymiany oleju", "oil-filter.replacement-interval": "Interwał wymiany filtra oleju", "coolant.specification": "Specyfikacja / typ płynu chłodniczego", "coolant.capacity": "Pojemność układu chłodzenia", "coolant.replacement-interval": "Interwał wymiany płynu chłodniczego", "coolant.fan-on-temperature": "Temperatura załączenia wentylatora", "spark-plug.model": "Model / oznaczenie świecy zapłonowej", "spark-plug.gap": "Szczelina elektrod świecy", "spark-plug.torque": "Moment dokręcania świecy", "spark-plug.inspection-interval": "Interwał kontroli świec", "spark-plug.replacement-interval": "Interwał wymiany świec", "valves.intake-clearance": "Luz zaworowy — ssące", "valves.exhaust-clearance": "Luz zaworowy — wydechowe", "valves.measurement-conditions": "Warunki pomiaru luzu", "valves.inspection-interval": "Interwał kontroli luzów zaworowych", "valves.adjustment-interval": "Interwał regulacji elementów zaworowych", "valves.system-notes": "Informacje o układzie zaworowym", "tires.front-size": "Rozmiar opony przedniej", "tires.rear-size": "Rozmiar opony tylnej", "tires.front-pressure-solo": "Ciśnienie przedniej opony — solo", "tires.rear-pressure-solo": "Ciśnienie tylnej opony — solo", "tires.front-pressure-loaded": "Ciśnienie przedniej opony — obciążenie", "tires.rear-pressure-loaded": "Ciśnienie tylnej opony — obciążenie", "rims.front-size": "Rozmiar przedniej felgi", "rims.rear-size": "Rozmiar tylnej felgi", "axles.front-torque": "Moment dokręcania przedniej osi", "axles.rear-torque": "Moment dokręcania tylnej osi", "final-drive.type": "Typ napędu końcowego", "sprocket.front-teeth": "Liczba zębów przedniej zębatki", "sprocket.rear-teeth": "Liczba zębów tylnej zębatki", "chain.slack": "Luz łańcucha", "chain-sprocket.replacement-interval": "Interwał wymiany łańcucha i zębatek", "belt.specification": "Specyfikacja paska napędowego", "belt.tension": "Luz / napięcie paska", "final-drive-oil.specification": "Olej w przekładni końcowej", "final-drive-oil.quantity": "Ilość oleju w przekładni końcowej", "final-drive-oil.replacement-interval": "Interwał wymiany oleju przekładni końcowej", "brake-fluid.specification": "Specyfikacja płynu hamulcowego", "brake-fluid.replacement-interval": "Interwał wymiany płynu hamulcowego", "brake-pads.front-minimum-thickness": "Minimalna grubość przednich klocków hamulcowych", "brake-pads.rear-minimum-thickness": "Minimalna grubość tylnych klocków hamulcowych", "brake-discs.front-minimum-thickness": "Minimalna grubość przedniej tarczy hamulcowej", "brake-discs.rear-minimum-thickness": "Minimalna grubość tylnej tarczy hamulcowej", "brake-pads.front-reference": "OEM / numer przednich klocków hamulcowych", "brake-pads.rear-reference": "OEM / numer tylnych klocków hamulcowych", "brakes.abs-system": "Informacja o ABS / typie układu hamulcowego", "battery.model": "Typ / model akumulatora", "battery.voltage": "Napięcie akumulatora", "battery.capacity": "Pojemność akumulatora Ah", "battery.cca": "Prąd rozruchowy CCA", "charging.voltage": "Napięcie ładowania", "fuse.main-rating": "Bezpiecznik główny — wartość [A]", "fuse.main-location": "Lokalizacja bezpiecznika głównego", "fuse.table": "Pozostałe bezpieczniki — funkcja, amperaż i lokalizacja", "fuse.spares": "Bezpieczniki zapasowe i ich wartości", "lighting.headlight": "Reflektor przedni — typ / moc", "lighting.position": "Światło pozycyjne — typ / moc", "lighting.rear-stop": "Światło tylne / STOP — typ / moc", "lighting.turn-signals": "Kierunkowskazy — typ / moc", "lighting.license-plate": "Oświetlenie tablicy rejestracyjnej — typ / moc", "lighting.instruments": "Kontrolki / podświetlenie zegarów", "lighting.other-sources": "Pozostałe źródła światła", "lighting.led-replaceability": "Wymienność modułu LED", "maintenance.air-filter-interval": "Interwał wymiany filtra powietrza", "maintenance.fuel-filter-interval": "Interwał kontroli / wymiany filtra paliwa", "maintenance.final-drive-interval": "Interwał kontroli układu napędowego", "oem.oil-filter": "Filtr oleju — numer OEM", "oem.air-filter": "Filtr powietrza — numer OEM", "oem.spark-plug": "Świece zapłonowe — numer OEM", "oem.front-brake-pads": "Przednie klocki hamulcowe — numer OEM", "oem.rear-brake-pads": "Tylne klocki hamulcowe — numer OEM", "oem.chain": "Łańcuch — numer / specyfikacja OEM", "oem.front-sprocket": "Zębatka przednia — numer OEM", "oem.rear-sprocket": "Zębatka tylna — numer OEM", "oem.fuel-filter": "Filtr paliwa — numer OEM", "oem.oil-drain-seal": "Uszczelka korka spustowego oleju — numer OEM", "oem.front-suspension-seals": "Uszczelniacze przedniego zawieszenia — numer OEM", "oem.wheel-bearings-seals": "Łożyska / uszczelniacze kół — numery OEM", "torque.rear-axle-chain-adjustment": "Moment tylnej osi / regulacji łańcucha", "torque.front-sprocket": "Moment dokręcania przedniej zębatki", "torque.rear-sprocket": "Moment dokręcania tylnej zębatki", "torque.final-drive-oil-plug": "Moment korka oleju przekładni końcowej", "torque.wheel-nuts": "Moment dokręcania śrub / nakrętek koła", "torque.handlebar-clamps": "Moment dokręcania zacisków kierownicy",
  ...
  const MATRIX_ALIASES = Object.freeze({
    "engine.displacement": ["engine.displacement", "general.engine.displacement"], "engine.power": ["engine.power", "general.engine.power"], "mass.wet-kerb": ["dimensions_mass.wet-kerb-mass", "general.mass.wet"], "fuel-tank.capacity": ["fuel_intake.tank-capacity", "general.fuel-tank.capacity"], "oil.specification": ["lubrication.oil-specification", "lubrication.engine-oil.specification"], "oil.viscosity": ["lubrication.viscosity", "lubrication.engine-oil.viscosity"], "oil.quantity-drain": ["lubrication.capacity-drain", "lubrication.engine-oil.capacity-drain"], "oil.quantity-filter": ["lubrication.capacity-filter", "lubrication.engine-oil.capacity-with-filter"], "oil-filter.reference": ["lubrication.oil-filter", "consumables.oil-filter.oem", "oem_parts.oil-filter"], "oil.drain-plug-torque": ["lubrication.drain-plug-torque", "torque.engine.oil-drain-bolt", "torques.oil-drain-bolt"], "oil.filter-torque": ["lubrication.filter-torque", "torque.engine.oil-filter", "torques.oil-filter"], "coolant.specification": ["cooling.coolant-specification", "cooling.coolant.specification"], "coolant.capacity": ["cooling.capacity", "cooling.coolant.capacity-engine-radiator"], "coolant.replacement-interval": ["cooling.replacement-interval"], "coolant.fan-on-temperature": ["cooling.fan-switch"], "spark-plug.model": ["ignition.spark-plug-oem", "ignition.spark-plug.standard"], "spark-plug.gap": ["ignition.plug-gap"], "spark-plug.torque": ["ignition.plug-torque", "torque.engine.spark-plug"], "spark-plug.inspection-interval": ["ignition.inspection-interval"], "spark-plug.replacement-interval": ["ignition.replacement-interval"], "valves.intake-clearance": ["valve_train.intake-clearance", "valves.clearance.intake-standard"], "valves.exhaust-clearance": ["valve_train.exhaust-clearance", "valves.clearance.exhaust-standard"], "valves.measurement-conditions": ["valve_train.measurement-conditions"], "valves.inspection-interval": ["valve_train.inspection-interval"], "tires.front-size": ["tires_wheels.front-size", "wheels.tire.front.size"], "tires.rear-size": ["tires_wheels.rear-size", "wheels.tire.rear.size"], "tires.front-pressure-solo": ["tires_wheels.solo-pressures", "wheels.tire.front.pressure-cold"], "tires.front-pressure-loaded": ["tires_wheels.loaded-pressures"], "rims.front-size": ["tires_wheels.rim-sizes", "wheels.rim.front.size"], "axles.front-torque": ["tires_wheels.front-axle-torque", "torque.chassis.front-axle-bolt"], "axles.rear-torque": ["tires_wheels.rear-axle-torque", "torque.chassis.rear-wheel-bolts"], "final-drive.type": ["final_drive.chain-size", "final-drive.chain.specification"], "sprocket.front-teeth": ["final_drive.front-sprocket", "final-drive.sprocket.front-teeth"], "sprocket.rear-teeth": ["final_drive.rear-sprocket", "final-drive.sprocket.rear-teeth"], "chain.slack": ["final_drive.chain-slack", "final-drive.chain.slack"], "brake-fluid.specification": ["brakes.brake-fluid", "brakes.fluid.specification"], "brake-fluid.replacement-interval": ["brakes.fluid-interval"], "brake-pads.front-minimum-thickness": ["brakes.pad-thickness-limit"], "brakes.abs-system": ["brakes.front-rear-configuration"], "battery.model": ["electrical.battery-specification", "electrical.battery.specification"], "battery.capacity": ["electrical.battery-capacity", "electrical.battery.capacity"], "charging.voltage": ["electrical.charging-voltage", "electrical.charging.regulated-voltage"], "fuse.table": ["electrical.fuse-ratings", "fuses.circuit.standard"], "lighting.headlight": ["lighting.combined-high-low", "lighting.headlight"], "lighting.position": ["lighting.front-position"], "lighting.rear-stop": ["lighting.rear-tail", "lighting.brake-light", "lighting.brake-tail"], "lighting.turn-signals": ["lighting.front-indicators", "lighting.rear-indicators"], "lighting.license-plate": ["lighting.license-plate"], "maintenance.air-filter-interval": ["maintenance.air-filter.replace"], "maintenance.fuel-filter-interval": ["maintenance.fuel-filter.inspect"], "maintenance.final-drive-interval": ["maintenance.drive-chain.inspect-lubricate"], "oem.oil-filter": ["oem_parts.oil-filter", "consumables.oil-filter.oem"], "oem.air-filter": ["oem_parts.air-filter"], "oem.spark-plug": ["oem_parts.spark-plugs"], "oem.front-brake-pads": ["oem_parts.front-brake-pads"], "oem.rear-brake-pads": ["oem_parts.rear-brake-pads"], "oem.chain": ["oem_parts.chain"], "oem.front-sprocket": ["oem_parts.front-sprocket"], "oem.rear-sprocket": ["oem_parts.rear-sprocket"], "oem.fuel-filter": ["oem_parts.fuel-filter"], "torque.rear-axle-chain-adjustment": ["torques.rear-axle", "torques.chain-adjusters"]
  });
  const LEGACY_VERIFIED_MATRIX_ALIASES = Object.freeze({
    "fuse.main-rating": ["fuses.main-a", "fuses.main-b"],
