...
test("Wave 1 totals and per-manufacturer sums are exact and deterministic", () => {
  ...
  assert.deepEqual(Object.fromEntries(report.perManufacturer.map(item => [item.id, [item.families, item.variants, item.variantYears]])), {
    aprilia: [8, 24, 110], bmw: [29, 135, 653], ducati: [18, 96, 404], "harley-davidson": [3, 15, 102], honda: [50, 180, 728], indian: [3, 6, 30], kawasaki: [47, 132, 647], ktm: [9, 38, 151], "moto-guzzi": [4, 11, 39], "royal-enfield": [3, 7, 35], suzuki: [54, 146, 881], triumph: [9, 38, 186], yamaha: [60, 177, 905]
  });
