...
const genericApplicabilityRef = factory.createApplicabilityRef({ targetIdentity: { targetId: "target.synthetic.model", catalogVariantKey: "synthetic.model" }, applicability: { modelYear: 2024, market: ["EU"], transmission: "manual", equipment: "standard", abs: true }, verificationId: "applicability-verification.000000000000000000000001", productionAuthorizationId: factory.authorizationId(synthetic()) });
const genericCatalogueIdentityRef = factory.createCatalogueIdentityRef({ targetIdentity: { targetId: "target.synthetic.model", catalogVariantKey: "synthetic.model" }, identityProof: { source: "repository-catalogue-and-research-target", targetId: "target.synthetic.model", catalogVariantKey: "synthetic.model" }, productionAuthorizationId: factory.authorizationId(synthetic()) });
...
allInputs["REGISTRY-INSERTION"] = [genericApplicabilityRef, genericCatalogueIdentityRef, genericProfileRef];
