...
test("project-state snapshot contains executable audit invariants", () => {
  ...
  assert.deepEqual(snapshot.ducatiPromotionReviewDecisions, { reviewed: 7, approvedForConversion: 7, needsPromotionReview: 0, rejectedForPromotion: 0, remainingDucatiPending: 20, bmwUnchanged: true, upstreamResearchStateChanged: false, productionStateChanged: false, promotionConversionPerformed: false });
  assert.deepEqual(snapshot.ducatiSchemaConversionProjection, { total: 7, conversionReady: 4, conversionBlocked: 3, blockedReasons: { "BATTERY-PAIR-REQUIRES-LOSSY-MERGE": 2, "COOLING-CIRCUIT-SCOPE-NOT-PROVEN-ENGINE-AND-RADIATOR": 1, "NO-LOSSLESS-STANDALONE-BATTERY-CAPACITY-ENTRY": 1 }, batteryLossless: false, coolingCapacityExact: false, productionProfileCreated: false, registryChanged: false, upstreamStateChanged: false });
