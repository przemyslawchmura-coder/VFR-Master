...
test("project-state snapshot contains executable audit invariants", () => {
  assert.equal(snapshot.snapshotBasis, "post-technical-research-factory-tenere-batch-pilot-design-working-tree");
  assert.equal(snapshot.snapshotImplementationPath, "research/data/technical-research-factory-tenere-batch-pilot.js");
