...
test("project-state snapshot contains executable audit invariants", () => {
  ...
  assert.deepEqual(snapshot.ducatiSchemaConversionProjection, { total: 7, conversionReady: 6, conversionBlocked: 1, blockedReasons: { "COOLING-CIRCUIT-SCOPE-NOT-PROVEN-ENGINE-AND-RADIATOR": 1 }, batteryLossless: true, coolingCapacityExact: false, productionProfileCreated: false, registryChanged: false, upstreamStateChanged: false });
