...
function buildReport() {
  ...
  return Object.freeze({ schemaVersion: "revlog-triumph-streettriple765-prospect-registration/v2", date: "2026-09-03", startingProspectId: "unknown.triumph.streettriple765", target: validatedTarget, prospect: validatedProspect, readiness, officialResearch: Object.freeze({ authoritySource: "https://www.triumphmotorcycles.com/owners/manuals", exactDocumentSource: "https://api.triumphtechnicalinformation.com/handbooks/documents/6493f9eab74cf69ba9a7301d/pdf", rangeMetadataSource: "https://www.triumphmotorcycles.co.uk/for-the-ride/news/motorcycles/street-triple-765-2022-11-03", sourceClass: "official Triumph owner handbook", publicationId: "3850186_2-EN", publicationIssue: "issue 2, June 2023", exactDocumentAuthenticated: true, metadataOnly: true, routeAccessResult: "official PDF accessible" }), metadataResolution: Object.freeze({ euApplicability: "UNRESOLVED", catalogueIdentitySupport: "UNRESOLVED", equipmentScope: "UNRESOLVED", absApplicability: "KNOWN", manualTransmissionApplicability: "KNOWN", findings: Object.freeze(["The authenticated global EN handbook record does not explicitly bind the publication to the EU market.", "The handbook identity combines S 660, R, R LRH and RS and does not establish a base-only identity.", "The official 2023 range metadata identifies R and RS variants (plus Moto2 Edition), but does not map the requested catalogue key to a base/R/RS identity.", "ABS and manual-transmission applicability are recorded as known for the prospect, but do not resolve the EU or equipment boundary."]) }), externalResearchPerformed: true, technicalValuesInspected: false, rawCandidatesCreated: 0, reviewQueueEntriesCreated: 0, humanReviewDecisionsCreated: 0, evidenceProcessingRecordsCreated: 0, evidenceRowsAdded: 0, researchedNoEvidenceAdded: 0, serviceCoreCoverageChanged: false, productionChanged: false, runtimeChanged: false, catalogueChanged: false, audit: Object.freeze({ classification: "ACCEPT-WITH-RISKS", conclusion: "Bounded Triumph-controlled metadata research authenticated the existing handbook and confirmed known ABS/manual dimensions, but did not safely resolve EU applicability, the base/R/R LRH/RS boundary, or the catalogue-key equipment mapping. Canonical readiness remains fail-closed and not execution-ready; no technical values were inspected.", risks: Object.freeze(["the official handbook explicitly combines S 660, R, R LRH and RS", "the global EN record does not establish EU market applicability by itself", "the official 2023 range metadata does not establish a base-only identity or safe catalogue-key mapping"]), falsification: Object.freeze(["no technical values were inspected", "no service/manual values were extracted", "no downstream research or production stage was invoked"]) }), exactNextTask: "Resolve only the Triumph MY2023 EU and base/R/RS applicability metadata for the authenticated 3850186_2-EN handbook; do not acquire or inspect content while those dimensions remain unresolved." });
}
