...
const RULES = Object.freeze({ [TORQUE_RULE.ruleKey]: TORQUE_RULE, [CAPACITY_RULE.ruleKey]: CAPACITY_RULE, [PRESSURE_RULE.ruleKey]: PRESSURE_RULE });
...
module.exports = Object.freeze({ RULES, TORQUE_RULE, CAPACITY_RULE, PRESSURE_RULE, createRule, evaluate, evaluateBatch });
