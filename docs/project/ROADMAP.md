...
Research on Demand Wave 1 is COMPLETE for the local contract proof. The
non-production reusable-demand identity, exact applicability lookup, partial
projection and duplicate-demand classification are implemented and synthetic-
fixture tested. Durable persistence, atomic claims, app integration and
external providers remain out of scope. NEXT is Research on Demand — Wave 2:
durable research demand/status plus reusable-knowledge persistence with atomic
deduplication.
