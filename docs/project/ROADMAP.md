...
Identity-mapping infrastructure is now available for bounded FZ1 research; the FZ1 planning wave authenticated one narrowly scoped owner-manual route and retained the service-manual code as a partial-authentication lead. The bounded `2D1X` acquisition wave acquired one official PDF and preserved its hash/provenance. The bounded extraction plan fixes six structural regions, explicit applicability/provenance gates and a 24-candidate ceiling. The generic extraction playbook and PDF trust boundary then drove one real raw-only pilot, yielding 14 deterministic candidates without review/evidence/promotion. Applicability remains narrow and unresolved dimensions remain explicit; this does not reopen the completed audited scope.
