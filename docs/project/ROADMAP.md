...
bounded Factory step is to construct one Review Queue entry for that existing
candidate before any Human Review Decision. Only one major phase is active at a time. Partial research is normal and
