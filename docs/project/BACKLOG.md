...
- Complete the deferred Technical Research Factory waves after the completed contract/orchestrator/planner/execution-agent/extraction-agent/review-queue/human-decision foundations: evidence processing, interrupted/resumed Ténéré Batch Pilot, then measured 10/25-target scale-up. Do not attempt 100 targets before checkpoint/review bottlenecks are measured.
